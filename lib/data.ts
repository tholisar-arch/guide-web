...
import pagesDataHu from "@/data/pages.hu.json";
import navDataHu from "@/data/nav.hu.json";
import pagesDataPt from "@/data/pages.pt.json";
...
import pagesDataCs from "@/data/pages.cs.json";
...
export const LOCALES: Locale[] = ["en", "fr", "it", "de", "nl", "hu", "pt", "pl", "ro", "cs"];
...
const apis: Record<Locale, DataApi> = {
  ...
  cs: createDataApi(pagesDataCs, navDataCs),
};
