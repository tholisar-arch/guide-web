...
PHRASE_DICT = {
    ...
    "DIN Back-Up for transformers": "DIN protection amont pour transformateurs",
    ...
    "Medium Acting": "Semi-temporisé",
    "Very Fast Acting": "Action très rapide",
    "Time Delay": "Temporisé",
    "Ferrule fuse-links Standard": "Fusibles cylindriques",
    "Glass fuses": "Fusibles en verre",
    "House Service": "Branchement individuel",
    "Insulated tags": "Pattes isolées",
    "Non-insulated tags": "Pattes non isolées",
