    ...
    <SelectorFrame title="Product Selector" backHref={parentHref}>
      <article>
        ...
        {entry.images.length > 0 && (
          <div className="mb-6 flex flex-wrap items-start gap-4 rounded-xl border border-ink-200 bg-ink-50 p-4 dark:border-ink-800 dark:bg-ink-950">
            {entry.images.map((img, i) => (
              <div
                key={i}
                className="relative flex items-center justify-center overflow-hidden rounded-lg bg-white dark:bg-ink-900"
                style={{
